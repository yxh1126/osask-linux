; apilib.nas - Haribote OS application API library
; Merged from api001.nas-api027.nas + alloca.nas
; Each function is a thin wrapper that issues an INT 0x40 syscall.
...
api_initmalloc:	; void api_initmalloc(void);
		PUSH	EBX
		MOV		EDX,8
		MOV		EBX,[CS:0x0020]		; Address of the malloc memory area
		MOV		EAX,EBX
